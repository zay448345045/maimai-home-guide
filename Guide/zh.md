...
世嘉在游戏编译上比较友好，为mono编译。Assembly-CSharp包含了世嘉额外添加的街机验证代码，不过通过反编译为源码，再修改报错代码和去除验证，重新编译即可。该文件在世嘉所有游戏中也没有什么改动，还是同上使用elorg的音游爱好者提供的即可。

![仓库图片](master/guide/10.png)
